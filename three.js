...
camera.position.set(-8981.36, 3139.17, 2016.13);
camera.quaternion.setFromEuler(new THREE.Euler(-0.4, -0.68, -0.26));
...
loader.load(
  'https://prod.spline.design/o8eWd-T7UApv48eO/scene.splinecode',
  (splineScene) => {
