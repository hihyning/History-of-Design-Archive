document.addEventListener('DOMContentLoaded', (event) => {
    ...
    let infoCardHeaders = [
        "POST WAR","Egg Chair by Arne Jacobsen (1958)","Graphic Design and Posters","Verner Panton: Panton Chair (1960)","Charles Harrison: View-Master (1939)", "Eero Aarnio: Ball Chair (1963)", "Eames: Molded Plywood Lounge Chair (1946)"
    ];
